            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <a href="{{ route('famous-locations.add') }}" class="btn btn-sm btn-outline-primary">Add New Famous Location</a>
                    </div>
                            ...
                            <tbody>
                                @foreach ($famouslocations as $i => $data)
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ route('famous-locations.updatestatus') }}" method="POST" class="d-inline-block">
                                                @csrf
                                                <label class="switch">
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route('famous-locations.delete') }}" method="POST" class="d-inline delete-form">
                                                @csrf
